...
2. Fix [[apps/carl-core/includes/header.php]] and [[apps/carl-core/includes/footer.php]] calls to ensure that they can be globally used. 

	   ***Honestly what is up with those filenames?***

3. Clean up the [[apps/carl-core/includes/shell.php]] to ensure it does not have any functions. Functions belong in [[common.php]]